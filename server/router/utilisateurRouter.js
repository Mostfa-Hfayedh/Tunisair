...
const{getAll, login, register, getOne, remove, update, getOneById, getAnalyses} = require("../controller/utilisateurController")
...
utilisateurRoute.post("/getAnalyses",getAnalyses)
